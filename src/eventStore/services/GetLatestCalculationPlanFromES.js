...
export async function replayLatestCalculationFromEvents() {
  ...
  // Initialize the calculations array
  const calculations = [];

  // Process only the latest event's monthlyCalculations data
  if (latestCalculationEvent.payload && latestCalculationEvent.payload.monthlyCalculations) {
    const monthlyCalculations = latestCalculationEvent.payload.monthlyCalculations;
    console.log(`[CalculationReplayService] Found monthly calculations for latest calculationId: ${latestCalculationEvent.calculationId}`);
    ...
    console.log("[CalculationReplayService] No monthly calculations found in the latest event.");
  }
...
export async function replayLatestCalculationFromEvents1() {
  console.log("[CalculationReplayService] Starting replay of CalculationPerformed events to find latest calculation ID.");
